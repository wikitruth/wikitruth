...
- Active checklist backlog:
  - `docs/plans/TENANT_APPLICATION_SHELL_PARITY_PLAN_2026-07-16.md` open `[ ]`: **12** (modern shell integration and rendered verification remain; tenant contract and knowledge scoping are complete)
...
- Deferred non-checklist history:
  - `docs/plans/DEPENDENCY_UPGRADE_PLAN_2026-02-24.md` remains at its canonical reference path; only its legacy-renderer retirement wave is deferred.
...
- `docs/dependencies/dep-upgrade-classification-2026-04-22.md`
