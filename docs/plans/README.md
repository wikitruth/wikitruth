...
- Product presentation: responsive Explore density, deterministic modern
  GeoPattern palettes, governed relationship actions instead of duplicated
  Move/Swap labels, and concise browser titles remain the accepted current
  behavior. Reconsider only under an explicit future UX, relationship,
  branding, or SEO scope.
