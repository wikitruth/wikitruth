...
1. The deprecation plan is now at `docs/plans/deferred/DEPRECATION_REPLACEMENT_PLAN.md`; its remaining Jade/Kraken renderer work was explicitly deferred on 2026-07-13.
