...
exports.find = function(req, res, next){
  ...
  req.app.db.models.AccountCategory.pagedFind({
    ...
    if (req.xhr) {
      ...
      results.filters = req.query;
      res.render('jade/admin/categories/index.jade', { data: { results: escape(JSON.stringify(results)) } });
    }
  });
};
...
exports.read = function(req, res, next){
  req.app.db.models.AccountCategory.findById(req.params.id).exec(function(err, category) {
    ...
    if (req.xhr) {
      ...
      res.render('jade/admin/categories/details.jade', { data: { record: escape(JSON.stringify(category)) } });
    }
  });
};
