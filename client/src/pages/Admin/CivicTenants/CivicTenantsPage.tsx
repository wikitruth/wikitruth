...
function formFromTenant(tenant: CivicTenant): FormState {
  return {
    ...
    extensionSchemas: JSON.stringify(tenant.extensionSchemas, null, 2), moderationPolicyVersion: tenant.moderationPolicyVersion,
    electionSystem: tenant.electionSystem, deploymentMode: tenant.deploymentMode,
  };
}
