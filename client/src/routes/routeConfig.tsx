...
export const appRoutes: AppRoute[] = [
  ...
  { path: '/arguments/create', element: protectedRoute(<ArgumentCreatePage />) },
  ...
  { path: '/questions/create', element: protectedRoute(<QuestionCreatePage />) },
  { path: '/questions/edit/:id', element: protectedRoute(<QuestionEditPage />) },
  ...
  { path: '/issues/create', element: protectedRoute(<IssueCreatePage />) },
  { path: '/issues/edit/:id', element: protectedRoute(<IssueEditPage />) },
  ...
  { path: '/opinions/create', element: protectedRoute(<OpinionCreatePage />) },
  { path: '/opinions/edit/:id', element: protectedRoute(<OpinionEditPage />) },
  ...
  { path: '/comments/create', element: protectedRoute(<OpinionCreatePage />) },
  ...
  { path: '/answers/create', element: protectedRoute(<AnswerCreatePage />) },
  { path: '/answers/edit/:id', element: protectedRoute(<AnswerEditPage />) },
  { path: '/answers/entry/:id', element: <AnswerEntryPage /> },
  { path: '/answers/entry/:id/discussion', element: <AnswerEntryPage /> },
  { path: '/artifacts', element: <ArtifactsPage /> },
  { path: '/artifacts/create', element: protectedRoute(<ArtifactCreatePage />) },
  { path: '/artifacts/edit/:id', element: protectedRoute(<ArtifactEditPage />) },
  ...
  { path: '/groups/create', element: protectedRoute(<GroupCreate />) },
  ...
  { path: '/members/profile', element: protectedRoute(<ProfilePage />) },
  { path: '/members/profile/settings', element: protectedRoute(<ProfileSettings />) },
  { path: '/members/:username/topics', element: <ProfileTopics /> },
  { path: '/members/profile/topics', element: protectedRoute(<ProfileTopics />) },
  { path: '/members/:username/journal', element: <ProfileJournal /> },
  { path: '/members/profile/journal', element: protectedRoute(<ProfileJournal />) },
  { path: '/members/:username/diary', element: <ProfileJournal /> },
  { path: '/members/profile/diary', element: protectedRoute(<ProfileJournal />) },
  { path: '/members/:username/contributions', element: <ProfileContributions /> },
  { path: '/members/profile/contributions', element: protectedRoute(<ProfileContributions />) },
  { path: '/members/:username/following', element: <ProfileFollowing /> },
  { path: '/members/profile/following', element: protectedRoute(<ProfileFollowing />) },
  { path: '/members/profile/pages', element: protectedRoute(<PagesIndex />) },
  { path: '/members/profile/pages/create', element: protectedRoute(<PageCreate />) },
  { path: '/members/:username/pages/:id', element: <PageView /> },
  { path: '/members/profile/pages/:id', element: protectedRoute(<PageView />) },
  { path: '/screening', element: protectedRoute(<ScreeningPage />, ['screener', 'reviewer', 'admin']) },
  { path: '/convert', element: protectedRoute(<ConvertPage />, ['admin']) },
