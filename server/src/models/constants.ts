...
const SCREENING_STATUS = {
  ...
  status3: {
    /* An entry can only be archived after it was accepted. */ code: 3,
    text: 'Archived',
  },
};
...
(window as unknown as Record<string, unknown>).WT_CONSTANTS = constants;
}

const constantsExport: Record<string, any> = constants;
export = constantsExport;
